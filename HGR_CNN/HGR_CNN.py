...
model_name = "autoencoder_model.h5"
...
if __name__ == "__main__":
    ...
    if (sys.argv[1] == predict_command and not(sys.argv[2].isspace())):
        ...
        model = cnn_model.CnnModel(filters_count, learning_rate, img_dataset_size, os.path.join(current_script_path, "current_model.h5"))
